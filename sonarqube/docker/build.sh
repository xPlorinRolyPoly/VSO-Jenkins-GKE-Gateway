...
DOCKER_BUILDKIT=1 docker buildx build \
  ...
  --build-arg "SONARQUBE_PLUGIN_GCS_PATHS=gs://de-nc-st-bu-docker-image-addins/sonar-salesforce-plugin-24.0.13.jar gs://de-nc-st-bu-docker-image-addins/sonar-codescanlang-plugin-24.0.13.jar" \
